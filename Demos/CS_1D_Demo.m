...
%% Plot Results
h4=figure; 
subplot(2,1,1); hold; plot(x_0,'-.r'); plot(x_hat1,'k*'); hold;  l2=legend('True','AMP'); axis([0 300 -.5 1.5])   
subplot(2,1,2);hold; plot(x_0,'-.r'); plot(x_hat2,'k*'); hold; l2=legend('True','NLM-AMP'); axis([0 300 -.5 1.5])   
